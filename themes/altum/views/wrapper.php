...
<html lang="<?= $this->language->language_code ?>">
    <head>
        ...
        <?php foreach(['custom.css', 'link-custom.css', 'projects.css', 'geral.css', 'linkscreate.css', 'biolink.css', 'animate.min.css'] as $file): ?>
    ...
    <body class="<?= \Altum\Routing\Router::$controller_settings['body_white'] ? 'background' : null ?>" data-theme-style="<?= \Altum\ThemeStyle::get() ?>">
        <?= $this->views['menu'] ?>
