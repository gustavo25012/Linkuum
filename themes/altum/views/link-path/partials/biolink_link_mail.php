...
<div class="my-3">
    <a href="#" data-toggle="modal" data-target="#mail_<?= $data->link->link_id ?>" class="principal <?= $data->link->design->link_class ?>" style="<?= $data->link->design->link_style ?>">
            ...
            <div class="modal-body">
                <form id="mail_form_<?= $data->link->link_id ?>" method="post" role="form">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="submit" class="principal"><?= $data->link->settings->button_text ?></button>
                    </div>
                </form>
            </div>
