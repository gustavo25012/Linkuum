            ...
            <div class="modal-body">
                <form name="create_link" method="post" role="form">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="submit" class="principal"><?= $this->language->create_link_modal->input->submit ?></button>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_biolink" method="post" role="form">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="submit" class="principal"><?= $this->language->create_biolink_modal->input->submit ?></button>
                    </div>
                </form>
            </div>
