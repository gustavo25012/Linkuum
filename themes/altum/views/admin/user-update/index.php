                ...
                <div class="col">
                    ...
                    <div id="plan_settings" style="display: none">
                        ...
                        <div class="custom-control custom-switch mb-3">
                            ...
                            <div><small class="form-text text-muted"><?= $this->language->admin_plans->plan->music_embeds_help ?></small></div>
                        </div>
                        ...
                        <div class="custom-control custom-switch mb-3">
                            ...
                            <div><small class="form-text text-muted"><?= $this->language->admin_plans->plan->video_embeds_help ?></small></div>
                        </div>
