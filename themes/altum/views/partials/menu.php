            ...
            <ul class="navbar-nav">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item d-flex align-items-center">
                        <a class="loginbtn" href="<?= url('login') ?>"><i class="fa fa-fw fa-sm fa-sign-in-alt"></i> <?= $this->language->login->menu ?></a>
                    </li>

                    <?php if($this->settings->register_is_enabled): ?>
                    <li class="nav-item d-flex align-items-center">
                        <a class="cadastro" href="<?= url('register') ?>"><i class="fa fa-fw fa-sm fa-plus"></i> <?= $this->language->register->menu ?></a>
                    </li>
                    <?php endif ?>
