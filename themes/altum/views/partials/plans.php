        ...
        <?php if($this->settings->plan_free->status == 1): ?>
            ...
            <div class="pricing-plan">
                ...
                <div class="pricing-body">
                    ...
                    <?php else: ?>
                        <a href="<?= Authentication::check() ? url('pay/free') : url('register?redirect=pay/free') ?>" class="btnaccept"><?= $this->language->plan->button->choose ?></a>
                    <?php endif ?>
                </div>
            </div>
            ...
            <?php foreach($plans as $plan): ?>
                ...
                >
                    ...
                    <div class="pricing-body">
                        ...
                        <a href="<?= Authentication::check() ? url('pay/' . $plan->plan_id) : url('register?redirect=pay/' . $plan->plan_id) ?>" class="btn btn-lg btn-lock btn-primary pricing-button"><?= $this->language->plan->button->choose ?></a>
                    </div>
                </div>
