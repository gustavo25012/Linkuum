        ...
        <?php if($this->settings->payment->is_enabled): ?>
            <div class="col-auto p-0">
                <?php if($this->user->plan_id == 'free'): ?>
                    <a href="<?= url('plan/upgrade') ?>" class="principal"><i class="fa fa-fw fa-arrow-up"></i> <?= $this->language->account->plan->upgrade_plan ?></a>
                <?php elseif($this->user->plan_id == 'trial'): ?>
                    <a href="<?= url('plan/renew') ?>" class="principal"><i class="fa fa-fw fa-sync-alt"></i> <?= $this->language->account->plan->renew_plan ?></a>
                <?php else: ?>
                    <a href="<?= url('plan/renew') ?>" class="principal"><i class="fa fa-fw fa-sync-alt"></i> <?= $this->language->account->plan->renew_plan ?></a>
                <?php endif ?>
            </div>
