    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_biolink_image" method="post" role="form">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="submit" class="principal"><?= $this->language->create_biolink_image_modal->input->submit ?></button>
                    </div>
                </form>
            </div>
