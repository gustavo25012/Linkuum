...
<div class="row">
    ...
    <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
                <button type="button" data-toggle="dropdown" class="principal"><i class="fa fa-fw fa-plus-circle"></i> <?= $this->language->project->links->create ?></button>

                <div class="dropdown-menu dropdown-menu-right">
                    <?php $biolink_link_types = require APP_PATH . 'includes/biolink_link_types.php'; ?>

                    <?php foreach($biolink_link_types as $key): ?>
                    <?php $no_access = (in_array($key, ['soundcloud', 'spotify']) && !$this->user->plan_settings->music_embeds) || in_array($key, ['youtube', 'vimeo', 'twitch', 'tiktok']) && !$this->user->plan_settings->video_embeds; ?>
                    <a
                        href="#"
                        class="dropdown-item <?= $no_access ? 'container-disabled' : null ?>"
                        data-toggle="modal"
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between">
                                ...
                                <div class="d-none d-md-block">
                                    <?php if(($data->link->type == 'biolink' && $data->link->subtype == 'base') || $data->link->type == 'link'): ?>
                                        ...
                                        <a href="<?= url('link/' . $data->link->link_id . '/statistics') ?>" class="estat"><i class="fa fa-fw fa-sm fa-chart-bar"></i> <?= $this->language->link->statistics->link ?></a>
                                        <?php endif ?>
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label><script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                <lord-icon
                                ...
                                </lord-icon> <?= $this->language->link->settings->url ?></label>
                            ...
                            <div class="form-group">
                                <label for="settings_title"> <?= $this->language->link->settings->title ?></label>
                                <input type="text" id="settings_title" name="title" class="form-control" value="<?= $data->link->settings->title ?>" required="required" />
                            </div>

                            <div class="form-group">
                                <label for="settings_description"> <?= $this->language->link->settings->description ?></label>
                            ...
                            <div class="form-group">
                                <label for="settings_text_color"> <?= $this->language->link->settings->text_color ?></label>
                            ...
                            <div class="form-group">
                                <label for="settings_background_type"> <?= $this->language->link->settings->background_type ?></label>
                            ...
                            <div <?= $this->user->plan_settings->leap_link ? null : 'data-toggle="tooltip" title="' . $this->language->global->info_message->plan_feature_no_access . '"' ?>>
                                <div class="<?= $this->user->plan_settings->leap_link ? null : 'container-disabled' ?>">
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="leap_link" type="text" class="form-control" name="leap_link" value="<?= $data->link->settings->leap_link ?>" <?= !$this->user->plan_settings->leap_link ? 'disabled="disabled"': null ?> />
                                        <small class="form-text text-muted"><?= $this->language->link->settings->leap_link_help ?></small>
                                    </div> -->
                                </div>
                            </div>

                            <!-- <button class="gray" type="button" data-toggle="collapse" data-target="#branding_container" aria-expanded="false" aria-controls="branding_container">
                            ...
                            <!-- <button class="gray" type="button" data-toggle="collapse" data-target="#analytics_container" aria-expanded="false" aria-controls="analytics_container">
                            ...
                            <!-- <button class="gray" type="button" data-toggle="collapse" data-target="#seo_container" aria-expanded="false" aria-controls="seo_container">
                            ...
                            <div class="collapse" id="seo_container">
                                <div <?= $this->user->plan_settings->seo ? null : 'data-toggle="tooltip" title="' . $this->language->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->seo ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            <label> <?= $this->language->link->settings->seo_title ?></label>
                                        ...
                                        <div class="form-group">
                                            <label> <?= $this->language->link->settings->seo_meta_description ?></label>
                            ...
                            <!-- <button class="gray" type="button" data-toggle="collapse" data-target="#utm_container" aria-expanded="false" aria-controls="utm_container">
                            ...
                            <button class="gray" type="button" data-toggle="collapse" data-target="#socials_container" aria-expanded="false" aria-controls="socials_container">
                            ...
                            <div class="collapse" id="socials_container">
                                <div <?= $this->user->plan_settings->socials ? null : 'data-toggle="tooltip" title="' . $this->language->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->socials ? null : 'container-disabled' ?>">
                                        <div class="form-group">
                                            <label for="settings_socials_color"> <?= $this->language->link->settings->socials_color ?></label>
                            ...
                            <button class="gray" type="button" data-toggle="collapse" data-target="#fonts_container" aria-expanded="false" aria-controls="fonts_container">
                            ...
                            <button class="gray" type="button" data-toggle="collapse" data-target="#protection_container" aria-expanded="false" aria-controls="protection_container">
                                ...
                                <div <?= $this->user->plan_settings->password ? null : 'data-toggle="tooltip" title="' . $this->language->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->password ? null : 'container-disabled' ?>">
                                        <div class="form-group">
                                            ...
                                            <input id="password" type="password" class="form-control" name="password" value="<?= $data->link->settings->password ?>" autocomplete="off" <?= !$this->user->plan_settings->password ? 'disabled="disabled"': null ?> />
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" name="submit" class="enviar"><?= $this->language->global->update ?></button>
                            </div>
                        </form>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-6 col-md-6">
                                        <div class="d-flex flex-column">
                                            ...
                                            >
                                                <strong><?= in_array($row->subtype, ['spotify', 'youtube', 'vimeo', 'tiktok', 'twitch', 'soundcloud', 'text', 'image', 'mail']) ? $this->language->link->biolink->{$row->subtype}->name : $row->settings->name ?></strong>
                                            </a>
                                    ...
                                    <div class="col-2">
                                        <?php if(!in_array($row->subtype, ['mail', 'text', 'image', 'youtube', 'vimeo', 'tiktok', 'twitch', 'spotify', 'soundcloud'])): ?>
